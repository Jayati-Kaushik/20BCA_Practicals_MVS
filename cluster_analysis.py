# -*- coding: utf-8 -*-
"""
Created on Mon Jan 31 23:05:09 2022
...
os.chdir("C:/Users/chris/Desktop/20BCAB23")
...
plt.scatter(df[labels == 0,0] , df[labels == 0,1], c= 'purple')
plt.scatter(df[labels == 1,0] , df[labels == 1,1], c= 'blue')
plt.scatter(df[labels == 2,0] , df[labels == 2,1], c= 'silver')
