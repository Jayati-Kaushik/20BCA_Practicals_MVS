...
x=np.array([[11,11,11,11,11,11],[21,21,21,21,21,21],[31,31,31,31,31,31],[41,41,41,41,41,411],[51,51,51,51,51,51],[61,61,61,61,61,61]])
print(x)

#2. Print the transpose of the above vector
X=np.array([[11,11,11,11,11,11],[21,21,21,21,21,21],[31,31,31,31,31,31],[4,4,4,4,4,4],[51,51,51,51,51,51],[61,61,61,61,61,61]]).T
print(X)
