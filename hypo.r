getwd()
setwd("C:/Users/DHANYA/Desktop/dhanya")
data=read.csv("df_final_features.csv")
t.test(data$GDP_Per_Capita_Constant_LCU_Value,mu=30)
t.test(data$GDP_Per_Capita_Constant_LCU_Value,mu=132 ,alternative="less",conf.level=0.85)
mean(data$GDP_Per_Capita_Constant_LCU_Value)
