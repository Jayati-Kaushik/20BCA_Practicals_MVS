# -*- coding: utf-8 -*-
"""
Created on Fri Dec 10 19:51:17 2021
...
#(a) Regression on negative correlation for one variable
X=mtcars[['highwaympg']]
Y=mtcars[['horsepower']]
...
#(b) Regression on positive correlation for one variable
X=mtcars[['wheelbase']]
Y=mtcars[['carlength']]
reg=linear_model.LinearRegression()
reg.fit(X,Y)
